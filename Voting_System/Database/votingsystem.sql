...
INSERT INTO `admin` (`id`, `username`, `password`, `firstname`, `lastname`, `photo`, `created_on`)
VALUES (1, 'admin', '$2y$10$eoDZ8wGMOvMB/l/jF8UKEeBv2Co97I5CqmkIu.sUQxisnpqVFZ8wm', 'Admin', 'Admin',
...
INSERT INTO `candidates` (`id`, `position_id`, `firstname`, `lastname`, `photo`, `platform`)
VALUES (1, 1, 'Heskey', 'Owira', '', 'Azimio'),
...
INSERT INTO `positions` (`id`, `description`, `max_vote`, `priority`)
VALUES (1, 'President', 2, 1);
...
INSERT INTO `voters` (`id`, `voters_id`, `password`, `firstname`, `lastname`, `photo`)
VALUES (1, 'XxVcQI8yLpCTlgq', '$2y$10$Ni1UEs2aViW3M9HxpkZBj.rPg3zTAS53uYax4Pbkah2sdWbFjsWrW', 'Jason', 'Ndirangu', ''),
...
INSERT INTO `votes` (`id`, `voters_id`, `candidate_id`, `position_id`)
VALUES (1, 1, 2, 1),
       (2, 2, 2, 1);
